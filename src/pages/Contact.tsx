...
import { Phone, Mail, MapPin, Clock, FileText, Loader2, CheckCircle, AlertCircle } from 'lucide-react';
      ...
      <section className="bg-gradient-to-b from-[#eaf6ee] to-[#f4faf6] text-dark-text py-16 sm:py-20 relative overflow-hidden border-b border-border-green/40">
        ...
        <Container className="relative z-10">
          ...
          <h1 className="font-heading font-extrabold text-3xl sm:text-4xl md:text-5xl text-dark-text mb-4 leading-tight tracking-tight">
            Consult With <span className="text-primary-green">Our Engineers</span>
          </h1>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-sm font-semibold text-dark-text leading-snug font-mono tracking-wider">
                      {sbnProfile.gst}
                    </p>
                  </div>
                </div>
